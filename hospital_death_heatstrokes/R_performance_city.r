...
Data_obs_pred_city_specific$Pred <- ifelse(Data_obs_pred_city_specific$Pred > 48, 48, Data_obs_pred_city_specific$Pred)
...
# get performance
RMSE_train <- RMSE(Obs = Data_train_city$SeverityHigherMid, Pred = Data_train_city$Pred)

MAE_train <- MAE(Obs = Data_train_city$SeverityHigherMid, Pred = Data_train_city$Pred)

Cor_train <- paste(
	cor.test(Data_train_city$SeverityHigherMid, Data_train_city$Pred)$estimate %>% round(., 2),
	" (",
	cor.test(Data_train_city$SeverityHigherMid, Data_train_city$Pred)$conf.int[1] %>% round(., 2),
	" to ",
	cor.test(Data_train_city$SeverityHigherMid, Data_train_city$Pred)$conf.int[2] %>% round(., 2),
	")",
	sep = ""
	)
...
# get performance
RMSE_test <- RMSE(Obs = Data_test_city$SeverityHigherMid, Pred = Data_test_city$Pred)

MAE_test <- MAE(Obs = Data_test_city$SeverityHigherMid, Pred = Data_test_city$Pred)

Cor_test <- paste(
	cor.test(Data_test_city$SeverityHigherMid, Data_test_city$Pred)$estimate %>% round(., 2),
	" (",
	cor.test(Data_test_city$SeverityHigherMid, Data_test_city$Pred)$conf.int[1] %>% round(., 2),
	" to ",
	cor.test(Data_test_city$SeverityHigherMid, Data_test_city$Pred)$conf.int[2] %>% round(., 2),
	")",
	sep = ""
	)
...
RMSE_train_city <- RMSE(Obs = Data_obs_pred_city_specific_train_sel$SeverityHigherMid, Pred = Data_obs_pred_city_specific_train_sel$Pred)
RMSE_test_city <- RMSE(Obs = Data_obs_pred_city_specific_test_sel$SeverityHigherMid, Pred = Data_obs_pred_city_specific_test_sel$Pred)

Cor_train_city <- paste(
	cor.test(Data_obs_pred_city_specific_train_sel$SeverityHigherMid, Data_obs_pred_city_specific_train_sel$Pred)$estimate %>% round(., 2),
	" (",
	cor.test(Data_obs_pred_city_specific_train_sel$SeverityHigherMid, Data_obs_pred_city_specific_train_sel$Pred)$conf.int[1] %>% round(., 2),
	" to ",
	cor.test(Data_obs_pred_city_specific_train_sel$SeverityHigherMid, Data_obs_pred_city_specific_train_sel$Pred)$conf.int[2] %>% round(., 2),
	")",
	sep = ""
	)

Cor_test_city <- paste(
	cor.test(Data_obs_pred_city_specific_test_sel$SeverityHigherMid, Data_obs_pred_city_specific_test_sel$Pred)$estimate %>% round(., 2),
	" (",
	cor.test(Data_obs_pred_city_specific_test_sel$SeverityHigherMid, Data_obs_pred_city_specific_test_sel$Pred)$conf.int[1] %>% round(., 2),
	" to ",
	cor.test(Data_obs_pred_city_specific_test_sel$SeverityHigherMid, Data_obs_pred_city_specific_test_sel$Pred)$conf.int[2] %>% round(., 2),
	")",
	sep = ""
	)
...
Data$Pred <- ifelse(Data$Pred > 48, 48, Data$Pred)
...
# get performance
RMSE_train <- RMSE(Obs = Data_train$SeverityHigherMid, Pred = Data_train$Pred) %>% print()

MAE_train <- MAE(Obs = Data_train$SeverityHigherMid, Pred = Data_train$Pred) %>% print()
...
# get performance
RMSE_test <- RMSE(Obs = Data_test$SeverityHigherMid, Pred = Data_test$Pred) %>% print()

MAE_test <- MAE(Obs = Data_test$SeverityHigherMid, Pred = Data_test$Pred) %>% print()
